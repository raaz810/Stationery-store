  ...
  return (
    ...
    <div className="max-w-screen-lg mx-auto py-16 px-4">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="text-2xl font-semibold mb-4">Welcome to <span className='text-blue-600'>Stationery Haven 📚</span> - Saraswati Stationery & Books</h2>
          <p className="text-lg text-gray-700">
          Saraswati Stationery & Books is a trusted shop located in the heart of Bhopal, offering a wide variety of books, stationery, and Xerox services. 
        ...
        <section>
          ...
          <p className="text-lg text-gray-700">
            At Saraswati Stationery & Books, we believe in offering a comprehensive selection of products for students, professionals, and creative individuals. 
        ...
        <section>
          ...
          <p className="text-lg text-gray-700">
            ...
            Once you place your order, simply visit our physical store at <Link target="_blank" to="https://maps.app.goo.gl/zjM8kqkShBgggySL6"><strong>20-1-44 Kolar Road, Ward-23, LNCT College Gate, Bhopal</strong></Link> to pick up your order. 
        ...
        <section>
          ...
          <p className="text-lg text-gray-700">
          Saraswati Stationery & Books is conveniently located at <Link target="_blank" to="https://maps.app.goo.gl/zjM8kqkShBgggySL6"><strong>20-1-44 Kolar Road, Ward-23, LNCT College Gate, Bhopal</strong></Link>.
